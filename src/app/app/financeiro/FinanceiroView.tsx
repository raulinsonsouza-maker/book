    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <p className="text-sm text-muted">
          {isProfessionalView
            ? "Pagamentos dos seus agendamentos no período selecionado."
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="surface p-4">
            <p className="text-xs font-medium uppercase tracking-wide text-muted">
              {isProfessionalView ? "Suas receitas" : "Receitas"}
            </p>
      ...
      {loading ? (
        ...
        <p className="surface p-8 text-sm text-muted">
          {isProfessionalView
            ? "Nenhum pagamento dos seus agendamentos neste período."
          ...
          <table className="w-full min-w-[720px] text-left text-sm">
            ...
            <tbody className="divide-y divide-border">
              {payments.map((p) => {
                ...
                const refSub =
                  p.booking?.pageTitle || (p.type === "checkout" ? "Checkout" : "");
                return (
                  <tr key={p.id}>
